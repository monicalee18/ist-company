    ...
    <div className="min-h-screen flex flex-col pb-[60px] mx-auto w-full" style={{ maxWidth: "1320px" }}>
      ...
      >
        ...
        <div className="flex items-center gap-[7px]">
          {artist.socials.tiktok && <SocialIcon type="tiktok" href={artist.socials.tiktok} />}
          {artist.socials.instagram && <SocialIcon type="instagram" href={artist.socials.instagram} />}
          {artist.socials.x && <SocialIcon type="x" href={artist.socials.x} />}
          {artist.socials.youtube && <SocialIcon type="youtube" href={artist.socials.youtube} />}
          {artist.socials.website && <SocialIcon type="website" href={artist.socials.website} />}
        </div>
      </motion.div>
